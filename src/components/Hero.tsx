        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              Your Child's
              <span className="block mt-2">Creative Journey</span>
            </h1>
            <p className="text-lg md:text-xl mb-8 max-w-xl mx-auto md:mx-0">
              Inclusive arts education for every child. Discover our programs in
              art, music, drama, dance, film, and more. Special needs
          ...
          <div className="md:w-1/2 relative">
            ...
            <div
              className="absolute top-1/3 -left-10 w-14 h-14 bg-rainbow-green rounded-lg -rotate-12 animate-float"
