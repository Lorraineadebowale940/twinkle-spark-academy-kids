      ...
      <div className="container px-4 relative z-10">
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
          ...
          <div className="md:w-1/2 relative z-0">
            {/* Enhanced Rainbow and Shooting Star Animation */}
            <div className="relative w-full aspect-square max-w-md mx-auto mt-8 md:mt-0">
              ...
              <div className="absolute w-12 h-12 bg-white rounded-full shadow-lg filter blur-sm top-0 left-1/4 animate-shooting-star">
                <div className="w-20 h-1 bg-gradient-to-r from-white via-yellow-300 to-transparent absolute -bottom-1 -right-16 rotate-45"></div>
              </div>
              
              <div className="absolute w-8 h-8 bg-white rounded-full shadow-lg filter blur-sm top-1/4 right-0 animate-shooting-star-alt">
                <div className="w-16 h-1 bg-gradient-to-r from-white via-yellow-300 to-transparent absolute -bottom-1 -right-12 rotate-30"></div>
              </div>
              
              <div className="absolute w-6 h-6 bg-white rounded-full shadow-lg filter blur-sm bottom-10 left-10 animate-shooting-star-slow">
                <div className="w-12 h-1 bg-gradient-to-r from-white via-yellow-300 to-transparent absolute -bottom-1 -right-10 rotate-60"></div>
              </div>
            </div>
