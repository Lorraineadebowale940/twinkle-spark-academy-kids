...
const SpecialNeeds = () => {
  const specialNeedsInfo = [
    {
      ...
      description:
        "Creative arts provide autistic children with sensory-appropriate ways to express themselves, develop social skills, and build confidence. Our structured yet flexible approach accommodates different sensory needs while celebrating neurodiversity.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Our child-led approach is perfect for children with PDA profiles. By framing activities as invitations rather than demands, and offering meaningful choices, we create a low-pressure environment where creativity can flourish.",
      benefits: [
    ...
    },
    {
      name: "ADHD",
      description:
        "Our movement-friendly, hands-on creative activities are ideal for children with ADHD. We provide the structure, positive reinforcement, and multisensory experiences that help channel energy into creative expression.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Arts education offers alternative pathways to learning that often bypass text-based challenges. Our multisensory approach helps strengthen areas that support literacy and numeracy through creative means.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "We believe in arts access for all bodies. Our adaptable approach ensures every child can fully participate in creative activities regardless of mobility or physical limitations.",
      benefits: [
  ...
  const lorraineProfile = {
    ...
    description:
      "With over 15 years of experience in inclusive learning environments, Lorraine has taught and directed performances worldwide at prestigious venues including The Royal Albert Hall, the O2 Arena, London Palladium, and Disney. Her passion for accessible arts education has transformed countless lives.",
    training:
        ...
        <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="lg:w-1/3 text-center">
                ...
                <h3 className="text-2xl font-bold mt-4">
                  {lorraineProfile.name}
                </h3>
                <p className="text-primary font-medium">
                  {lorraineProfile.role}
                </p>
              </div>
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">
              Inclusive Arts for Every Child
            </h2>
            <p className="text-lg text-center mb-8 max-w-3xl mx-auto">
              At Rainbow Spark, we believe that every child deserves access to
              high-quality creative education. Our specialized programs and
              trained staff ensure that children with special needs can fully
            ...
            <Tabs defaultValue="approach">
              ...
              <TabsContent value="approach" className="mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <div className="bg-muted p-6 rounded-xl flex flex-col items-center text-center">
                    ...
                    <p>
                      Thoughtfully designed spaces that accommodate various
                      needs and abilities.
                    </p>
                  </div>
                  ...
                  <div className="bg-muted p-6 rounded-xl flex flex-col items-center text-center">
                    ...
                    <p>
                      Personalized approaches that adapt to each child's unique
                  ...
                  <div className="bg-muted p-6 rounded-xl flex flex-col items-center text-center">
                    ...
                    <p>
                      Specialists trained in various special education
                  ...
                  <div className="bg-muted p-6 rounded-xl flex flex-col items-center text-center">
                    ...
                    <p>
                      Programs that encourage self-expression and build
              ...
              <TabsContent value="gaming" className="mt-0">
                <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
                  ...
                  <p className="mb-6">
                    Digital games offer structured, predictable environments
                    that many neurodivergent children, particularly those with
                    autism, find comforting and engaging. We incorporate gaming
                    elements and principles into our learning to create bridges
                    between special interests and broader skills development.
                  </p>
                  ...
                  <div className="mt-6 p-4 bg-muted rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <p>
                        <span className="font-bold">Our approach:</span> We
                        don't just use games as rewards, but integrate gaming
                        principles into learning. Through game-based activities,
                        we develop transferable skills like turn-taking,
                        collaboration, problem-solving, and creative expression
                        in ways that feel safe and motivating.
                      </p>
                    </div>
                  </div>
                </div>
